...
export class StoreAccess extends Component {
    ...
    constructor(props) {
        super(props);
        this.selectors = {
            distributive: (storeState) => storeState.modelData.distributives[0],
            academic: (storeState) => storeState.modelData.academics[0],
            other: (storeState) => storeState.modelData.others[0],
