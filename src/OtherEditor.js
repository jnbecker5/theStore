...
export class OtherEditor extends Component {
    ...
    constructor(props) {
        ...
        this.state = {
            formData: {
                ...
                semester: props.other.semester || "", 
                prefix: props.other.prefix || "",
                number: props.other.number || "",
                grade: props.other.grade || "",
                editing: props.other.editing || ""
            }
        }
    }
