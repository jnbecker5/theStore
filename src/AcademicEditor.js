...
export class AcademicEditor extends Component {
    ...
    constructor(props) {
        ...
        this.state = {
            formData: {
                id: props.academic.id || "",
                description: props.academic.description || "", 
                semester: props.academic.semester || "", 
                prefix: props.academic.prefix || "",
                number: props.academic.number || "",
                grade: props.academic.grade || "",
                editing: props.academic.editing || ""
            }
        }
    }
